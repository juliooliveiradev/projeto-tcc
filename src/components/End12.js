...
import img1 from '../images/SegundaEtapa/Question12/codigo 9.jpg';
import img2 from '../images/SegundaEtapa/Question12/CodigoVA9.png';
...
const End12 = ({ results,
    ...
    vetorOutput }) => {
        ...
        const decimal = userInput.split('').reduce((acc, digit) => acc * 10 + (digit.charCodeAt(0) - 48), 0);
  return (
    <div className="card">
      <div className="card-content">
        <div className="content">
          ...
          <p><strong>Palavra inserida:</strong> {userInput}</p>
          <p><strong>Palavra convertida em um numero decimal:</strong> {decimal}</p>
          <ul>
