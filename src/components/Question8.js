...
import img1 from '../images/SegundaEtapa/Question8/Action2.jpg';
import img2 from '../images/SegundaEtapa/Question8/codigo2.jpg';


const Question8 = ({ data, onAnswerUpdate, numberOfQuestions, activeQuestion, onSetActiveQuestion, onSetStep, onConcatIndex, numberInput, onSetNumberInput, indexInput, onSetIndexInput, numberInput1, onSetNumberInput1 }) => {
  ...
  const nextClickHandler = () => {
    ...
    if(activeQuestion === 0){
        numberInput = prompt("Por favor, digite um valor de x: ");
        numberInput1 = prompt("Por favor, digite um valor da quantidade de termos:");
        onSetNumberInput(numberInput);
        onSetNumberInput1(numberInput1);
    ...
    else if (activeQuestion === numberOfQuestions - 1 && indexInput < numberInput1)  {
      onSetIndexInput(indexInput + 1);
      onSetActiveQuestion(activeQuestion - 4);
