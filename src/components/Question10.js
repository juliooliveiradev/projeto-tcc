...
import img1 from '../images/SegundaEtapa/Question10/Action2.jpg';
import img2 from '../images/SegundaEtapa/Question10/codigo2.jpg';
...
const Question10 = ({ data,
  ...
  const nextClickHandler = () => {
    ...
    if(activeQuestion === 0){
        ...
        console.log("indeximput " + indexInput);
    ...
    } else if (activeQuestion === numberOfQuestions - 1 && Math.floor(indexInput / 10) > 0)  {
        onSetIndexInput(Math.floor(indexInput / 10));
