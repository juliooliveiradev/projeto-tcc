...
import img1 from '../images/SegundaEtapa/Question5/Action2.jpg';
import img2 from '../images/SegundaEtapa/Question5/codigo2.jpg';
import img3 from '../images/SegundaEtapa/Question5/Action5.jpg';
import img4 from '../images/SegundaEtapa/Question5/codigo5.jpg';

const Question5 = ({ data, onAnswerUpdate, numberOfQuestions, activeQuestion, onSetActiveQuestion, onSetStep, onConcatIndex, numberInput, onSetNumberInput, vetorOutput, onSetVetorOutput, indexInput, onSetIndexInput }) => {
  ...
  const nextClickHandler = () => {
    ...
    console.log("indexinput=" + indexInput);
    if(activeQuestion === 2){
      Nota  = prompt("Por favor, digite um valor da Nota:");
      onSetVetorOutput((prevVetor) => [...prevVetor, Nota]);
    ...
    else if (activeQuestion === numberOfQuestions - 1 && indexInput > 1)  {
    ...
    <div className="card">
      <div className="card-content">
        <div className={`content ${answered && checkAnswer() ? 'has-background-success' : ''}`}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            {activeQuestion === 3 && <img src={img3} alt={`Imagem da pergunta ${activeQuestion + 1}`} />}
            {activeQuestion === 3 && <img src={img4} alt={`Imagem da pergunta ${activeQuestion + 1}`} />}
          </div>
          {selected && (
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
